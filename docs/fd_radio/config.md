...
Config.FrameProps = {
    new = {
        ['default'] = 'prop_serto_radio_black',
        ['red'] = 'prop_serto_radio_red',
        ['blue'] = 'prop_serto_radio_blue',
        ['green'] = 'prop_serto_radio_green',
        ['yellow'] = 'prop_serto_radio_yellow',
        ['white'] = 'prop_serto_radio_black',
    },
    old = {
